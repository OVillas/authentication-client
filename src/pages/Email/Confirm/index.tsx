...
import OtpInput from '../../../ui/components/inputs/UserForm/OtpInput'
...
export const ConfirmEmail = () => {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            isLogged ? navigate('/email/confirm') : alert('Invalid credentials')
        } catch (error) {
            alert(error)
        } finally {
            setIsLoading(false)
    ...
    return (
        <div className="bg-gray-300 w-full h-screen flex items-center justify-center">
            ...
            <div className="bg-gray-100 w-full hidden md:flex flex-1 flex-col max-w-xl h-screen sm:h-[48rem] md:h-[40rem] items-center py-12 shadow-lg">
